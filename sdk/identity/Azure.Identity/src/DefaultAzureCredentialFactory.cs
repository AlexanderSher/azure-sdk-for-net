...
namespace Azure.Identity
{
    internal class DefaultAzureCredentialFactory
    {
        ...
        {
            return new InteractiveBrowserCredential(tenantId, Constants.DeveloperSignOnClientId, new InteractiveBrowserCredentialOptions { TokenStorage = new PersistentTokenStorage() }, Pipeline);
        }
